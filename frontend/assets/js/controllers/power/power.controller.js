...
const objForm = new Form('powerForm', 'edit-input');
const objModal = new bootstrap.Modal(document.getElementById('appModal'));
const objTable = new Table ('app-table',['id','name','damage','energy','effect']);
