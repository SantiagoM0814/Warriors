...
const objForm = new Form('playerForm', 'edit-input');
const objModal = new bootstrap.Modal(document.getElementById('appModal'));
const objTable = new Table ('app-table',['id','name','created_at']);
