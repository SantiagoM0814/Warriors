...
const sqlStatements = [
  ...
  `CREATE TABLE warrior (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (breed_fk) REFERENCES breed(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (magic_fk) REFERENCES magic(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (typeWarrior_fk) REFERENCES type_warrior(id) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB;`,
  ...
  `CREATE TABLE warrior_power (
    ...
    FOREIGN KEY (power_fk) REFERENCES power(id) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB;`,
  ...
  `CREATE TABLE user (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (role_fk) REFERENCES role(id) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB;`,
